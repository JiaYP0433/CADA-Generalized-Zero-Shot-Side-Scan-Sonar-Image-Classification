...
class PhotoWCT(nn.Module):
    def __init__(self, mode='none'):
        ...
        style_mode = 'photowct'
        wct_path = 'datasets/transfer/params/{}/photo_wct.pth'.format(style_mode)
